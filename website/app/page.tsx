...
function ToolIcon({ name }: { name: string }) {
  ...
  if (key.includes("github")) {
    return <img className="tool-icon" src={sitePath("brand/github.svg")} alt="" aria-hidden="true" />;
  }
  ...
  if (key.includes("hugging")) {
    return <img className="tool-icon" src={sitePath("brand/huggingface.svg")} alt="" aria-hidden="true" />;
  }
